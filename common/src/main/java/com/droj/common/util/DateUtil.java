...
public final class DateUtil {
     ...
     * @since 1.0
     */
    public static String formatDateTime(Date date, Object... pattern) {
        String formatDate = null;
        if (pattern != null && pattern.length > 0) {
            formatDate = DateFormatUtils.format(date, pattern[0].toString());
        } else {
    ...
    public static Date nextDay(Date calDate, int num) {
        Calendar curr = Calendar.getInstance();
        curr.setTime(calDate);
        curr.set(Calendar.DAY_OF_MONTH, curr.get(Calendar.DAY_OF_MONTH) + num);
        return curr.getTime();
    }
     ...
     * @since 1.0
     */
    public static Date nextMonth(Date calDate, int num) {
        Calendar curr = Calendar.getInstance();
        curr.setTime(calDate);
        curr.set(Calendar.MONTH, curr.get(Calendar.MONTH) + num);
        return curr.getTime();
    ...
    public static Date getSpecifiedDateAfter(String specifiedDay, int num) {
        Date specifiedDate = parseDate(specifiedDay);
        Calendar c = Calendar.getInstance();
        c.setTime(specifiedDate);
        int day = c.get(Calendar.DATE);
...
//        String dayAfter = formatDate(c.getTime(), DateUtil.DATE_FORMAT);
     ...
     * @since 1.0
     */
    public static String getSpecifiedDayPev(String specifiedDay, int num) {
        Date specifiedDate = parseDate(specifiedDay);
        Calendar c = Calendar.getInstance();
        c.setTime(specifiedDate);
        c.add(Calendar.DAY_OF_MONTH, -num);
        String dayPre = formatDate(c.getTime(), DateUtil.DATE_FORMAT);
        return dayPre;
    }
     ...
     * @return
     */
    public static List<Map<String, Object>> getBeforeDays(int n) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            resultMap.put("date", calendar.getTime().getTime());
            resultMap.put("dateStr", sdf.format(calendar.getTime()));
            int w = calendar.get(Calendar.DAY_OF_WEEK) - 1;
            resultMap.put("weekStr", weekDays[w]);
        ...
        if (resultMapList != null && resultMapList.size() > 1) {
            Collections.sort(resultMapList, new Comparator<Map<String, Object>>() {
                ...
                public int compare(Map<String, Object> o1, Map<String, Object> o2) {
                    Long o1Value = Long.valueOf(String.valueOf(o1.get("date")));
                    Long o2Value = Long.valueOf(String.valueOf(o2.get("date")));
